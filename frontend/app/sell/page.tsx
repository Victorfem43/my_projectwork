...
export default function SellPage() {
  ...
  const [nextUpdateIn, setNextUpdateIn] = useState(30 * 60); // seconds
      ...
      <div className="min-h-screen">
        ...
        <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl font-bold mb-8">Sell</h1>
            <p className="text-gray-400 mb-6">Sell cryptocurrency or gift cards. Crypto prices update live from the market.</p>
            ...
            {activeTab === 'crypto' ? (
              <>
                <h2 className="text-xl font-bold mb-2">Cryptos to sell</h2>
                    ...
                    {cryptoMarket.map((asset) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <button className="bg-gradient-to-r from-red-600 to-pink-600 text-white font-semibold py-3 px-6 rounded-lg w-full hover:shadow-xl transition-all">
                            Sell {asset.symbol}
                          </button>
                        </Link>
                      );
              ...
              <>
                <h2 className="text-xl font-bold mb-4">Gift cards to sell</h2>
                <p className="text-gray-400 text-sm mb-6">Select a gift card brand to sell. You receive the listed rate of the face value.</p>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {giftCards.length === 0 ? (
                    <p className="text-gray-400 col-span-full py-8">No gift cards available to sell at the moment.</p>
                  ) : (
                    giftCards.map((card) => (
                      <Link
                        key={card._id}
                      ...
                      >
                        ...
                        <p className="text-gray-400 text-sm mb-2">Sell your {card.brand} gift card</p>
                        <button className="bg-gradient-to-r from-red-600 to-pink-600 text-white font-semibold py-3 px-6 rounded-lg w-full hover:shadow-xl transition-all">
                          Sell {card.brand} Gift Card
                        </button>
                      </Link>
                    ))
                  )}
